...
class mapbbcode {
	...
	public function get_bbcodes() {
        ...
        'second_pass_replace'	=> '\'<div id="map${1}\'.md5(\'${2}${3}\').\'">[map${2}]${3}[/map]</div><script language="javascript">if(mapBBcode) mapBBcode.show(\\\'map${1}\'.md5(\'${2}${3}\').\'\\\');</script>\'',
			],
			'mapid'	=> [
        'bbcode_tag'			=> 'mapid',
        'bbcode_helpline'		=> '',
        ...
        'second_pass_replace'	=> '\'<div id="map${1}${2}"></div><script language="javascript">if(mapBBcode) mapBBcode.showExternal(\\\'map${1}${2}\\\', \\\'${2}\\\');</script>\'',
			]
		];
	}
}
